...
# Objective
m.setObjective(quicksum(quicksum(quicksum(X[c,l,w] for w in W)*DD[c][l]for l in LVC) for c in CCD) 
               + quicksum(quicksum(Y[i,l]*ID[i][l]*0.2+CD[i]*Y[i,l] for i in IMD) for l in LVC))
